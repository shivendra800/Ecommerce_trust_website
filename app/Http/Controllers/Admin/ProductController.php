...
class ProductController extends Controller
{
    ...
    public function store(ProductFormRequest $request)
    {
        ...
        $product = $category->products()->create([
            ...
            'featuredproducts'=>$request->featuredproducts == true ? '1':'0',
    ...
    public function update(ProductFormRequest $request, int $product_id)
    {
        ...
        $product = Category::findOrFail($validatedData['category_id'])
            ...
            {
                return redirect('admin/products')->with('messsage','No');
            }
    ...
    public function destroy(int $product_id)
    {
        ...
        public function updateProductColorQty(Request $request, $prod_color_id)
        {
                   $productColorData = Product::findOrFail($request->product_id)
                    ...
                    return response()->json(['message'=>'Product Color Qty Upated']);
        }
