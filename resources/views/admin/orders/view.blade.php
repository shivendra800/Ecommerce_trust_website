        ...
        <div class="card border mt-3">
            ...
            <div class="card-body">
                        ...
                        <h4 class="text-primary">
                            ...
                            <a href="{{ url('admin/invoice/'.$order->id.'/generate')}}" class="btn btn-primary btn-sm text-white float-end">Download Invoice</a>
                            <a href="{{ url('admin/invoice/'.$order->id)}}" target="_blank" class="btn btn-warning btn-sm text-white float-end">View Invoice</a>
                            <a href="{{ url('admin/invoice/'.$order->id.'/mail')}}" class="btn btn-info btn-sm text-white float-end">Send Invoice Via Mail</a>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <h6 class="border p-2 text-success">Oder Status Message :
