          ...
          <div class="container-fluid">
              <div class="row">
                  <div class="col-md-2 my-auto d-none d-sm-none d-md-block d-lg-block">
                      ...
                      <img src="{{ url('/') }}/logo.png" alt="" style=" height: 65px;">
                  </div>
      ...
      <nav class="navbar navbar-expand-lg">
          <div class="container-fluid ">
              <a class="navbar-brand d-block d-sm-block d-md-none d-lg-none " href="#">
                  {{-- <img src="{{ url('/') }}/logo.png" alt="" style=" height: 100px;"> --}}
              </a>
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                      ...
                      <li class="nav-item">
                          <a class="nav-link" href="{{ url('collections') }}">All Services</a>
                      </li>
                      <li class="nav-item">
                          <a class="nav-link" href="{{ url('new-arrivals') }}">New Arrivals</a>
                      </li>
                      <li class="nav-item">
                          <a class="nav-link" href="{{ url('featured-products') }}">Hotels</a>
                      </li>
                      <li class="nav-item">
                          <a class="nav-link" href="{{ url('dharamshala') }}">Dharamshala</a>
                      </li>
                      {{-- <li class="nav-item">
